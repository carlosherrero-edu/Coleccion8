...
public class AdivinaNumero {
	...
	public static void main(String[] args) {
		...
		/*
		 * Otra forma de generar el numero aleatorio entre 1 y 100 usando la clase basica
		 * Math.random() es la siguiente:
		 * 
				...
				try {
					...
					if (numero < 1 || numero > 100)
						throw new NumberFormatException(
								"El número debe estar comprendido entre 1 y 100." + " Vuelve a intentarlo  :");
					esValido = true;
				}
